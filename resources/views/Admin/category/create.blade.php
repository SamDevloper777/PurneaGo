...
<div class=" mx-auto px-10 md:px-24 py-8">
    <h1 class="md:text-xl text-lg font-semibold  text-slate-500 mb-8 border-s-4 border-s-blue-400 pl-3">Create New Category</h1>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="parent_id" id="parent_id" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Parent ID (optional)">
        </div>

        <!-- Level -->
        <div class="mb-4">
            <label for="level" class="block text-gray-700 font-medium mb-2">Level</label>
            <input type="number" name="level" id="level" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Level (optional)">
        </div>

        <!-- Name -->
        <div class="mb-4">
            <label for="name" class="block text-gray-700 font-medium mb-2">Name</label>
            <input type="text" name="name" id="name" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Category Name" required>
        </div>

        <!-- Order Level -->
        <div class="mb-4">
            <label for="order_level" class="block text-gray-700 font-medium mb-2">Order Level</label>
            <input type="number" name="order_level" id="order_level" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Order Level (optional)">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="meta_title" id="meta_title" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Meta Title (optional)">
        </div>

        <!-- Meta Description -->
        <div class="mb-4">
            <label for="meta_description" class="block text-gray-700 font-medium mb-2">Meta Description</label>
            <textarea name="meta_description" id="meta_description" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Meta Description (optional)" rows="4"></textarea>
        </div>
